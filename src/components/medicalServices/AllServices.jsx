...
const AllServices = ({ data, isPending, handleEditClick }) => {
      ...
      <div className="min-w-full">
        ...
        >
          <thead className="bg-gray-100 text-gray-600 uppercase text-xs">
            <tr>
              {["Image", "name", "hospital", "order", "type", "actions"].map(
                (key) => (
                  <th
                    key={key}
              ...
              currentServices.map((service) => (
                <tr key={service.id} className="border-b border-gray-200">
                  <td className="py-4 px-3 text-center">
                    <Link to={`/medical-service/${service.id}`}>
                      <img
                        src={service.image ? service.image : "/Joystick.svg"}
                        alt={service.name}
                  ...
                  <td className="py-4 px-3 text-center">
                    {service.hospital ? service.hospital.name : "No Hospital"}
                  </td>
                  <td className="py-4 px-3 text-center">
                    {service.sort_order}
                  </td>
